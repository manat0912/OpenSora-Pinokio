...
# Add the parent directory to sys.path to find the opensora module
...
HF_STDIT_MAP = {
    "t2v": {
        "360p": "hpcai-tech/OpenSora-STDiT-v3",
        "720p": "hpcai-tech/OpenSora-STDiT-v3",
    },
    "i2v": "hpcai-tech/OpenSora-STDiT-v3",
}
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column():
                ...
                reference_image = gr.Image(label="Image (optional)")
