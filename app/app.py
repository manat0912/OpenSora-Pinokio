...
CONFIG_MAP = {
    "v1.2-stage3": "configs/diffusion/inference/256px.py",
}
...
# ============================
def install_dependencies(enable_optimization=True):
    """
...
def run_inference(
    ...
    with torch.inference_mode():
        ...
        if mode == "Text2Image":
            ...
            num_frames = int(length) if isinstance(length, (str, int, float)) else length
