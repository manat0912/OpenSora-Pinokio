  ...
  run: [
    // nvidia windows 
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "uv pip install liger-kernel>=0.4.0 --no-deps"
        ]
      },
      "next": null
    },
    // nvidia linux
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "uv pip install liger-kernel>=0.4.0 colossalai>=0.4.4"
        ]
      },
      "next": null
    },
    // amd windows
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch torch-directml torchaudio torchvision numpy==1.26.4 liger-kernel>=0.4.0 --no-deps --force-reinstall",
    },
    "next": null
    },
    // amd linux (rocm)
    ...
    // apple silicon mac
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch==2.7.0 torchvision==0.22.0 torchaudio==2.7.0 liger-kernel>=0.4.0 --no-deps --index-url https://download.pytorch.org/whl/cpu --force-reinstall --no-deps",
      },
      "next": null
    },
    // intel mac
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch==2.2.2 torchvision==0.17.2 torchaudio==2.2.2 --index-url https://download.pytorch.org/whl/cpu liger-kernel>=0.4.0 --no-deps --force-reinstall --no-deps"
      }
    },
    // cpu
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch==2.7.0 torchvision==0.22.0 torchaudio==2.7.0  --index-url https://download.pytorch.org/whl/cpu liger-kernel>=0.4.0 --no-deps --force-reinstall --no-deps"
      }
    }
  ]
}
